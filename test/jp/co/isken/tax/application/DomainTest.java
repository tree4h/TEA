...
public class DomainTest extends BaseModelTest {
	...
	//消費税条項
	TaxCondition RD_S = new TaxCondition(RoundingRule.ROUNDDOWN, TaxUnitRule.SUM);
	TaxCondition RD_D = new TaxCondition(RoundingRule.ROUNDDOWN, TaxUnitRule.DETAIL);
	TaxCondition RD_C = new TaxCondition(RoundingRule.ROUNDDOWN, TaxUnitRule.CHEAPER);
	TaxCondition RO_S = new TaxCondition(RoundingRule.ROUNDOFF, TaxUnitRule.SUM);
	TaxCondition RO_D = new TaxCondition(RoundingRule.ROUNDOFF, TaxUnitRule.DETAIL);
	TaxCondition RO_C = new TaxCondition(RoundingRule.ROUNDOFF, TaxUnitRule.CHEAPER);
	TaxCondition RU_S = new TaxCondition(RoundingRule.ROUNDUP, TaxUnitRule.SUM);
	TaxCondition RU_D = new TaxCondition(RoundingRule.ROUNDUP, TaxUnitRule.DETAIL);
	TaxCondition RU_C = new TaxCondition(RoundingRule.ROUNDUP, TaxUnitRule.CHEAPER);
	//代金条項
	PaymentCondition RD = new PaymentCondition(RoundingRule.ROUNDDOWN);
	...
	public static void setUpClass() {
		System.out.println("initTest:消費税、商品の登録");
		//消費税の作成
		tr1.save();
		tr2.save();
		tr3.save();
	...
	public void UC002ー01ー01() {
		...
		//取引先、契約の作成
		Party client01 = new Party("切り捨て-合計", PartyType.法人);
		Contract contract01 = new Contract(ContractType.SALES, client01, new DateRange(date("2013/07/28"),date("2014/07/28")), RD_S, RD,date("2013/07/28"));
		client01.save();
		contract01.save();
		//注文
		Order o = new Order(client01.getId(), DealType.販売取引, true, TaxedDealType.社外取引, date("2013/07/30"), ComputeType.外税);
		o.createCE(goods1.getId(), 5.5, Unit.KG);
		o.createCE(goods2.getId(), 8.3, Unit.KG);
		//代金計算
		o.createPayment();
		double price1 = o.getPayment(goods1);
		double price2 = o.getPayment(goods2);
		double tax = o.getTax();
		//代金確認
		...
		o.commit();
		//レシート表示
		CommercialTransaction ct = o.getCT();
	...
	public void UC002ー01ー02() {
		...
		//取引先、契約の作成
		Party client02 = new Party("切り捨て-明細", PartyType.法人);
		Contract contract02 = new Contract(ContractType.SALES, client02, new DateRange(date("2013/07/28"),date("2014/07/28")), RD_D, RD,date("2013/07/28"));
		client02.save();
		contract02.save();
		// 注文
	...
	public void UC002ー01ー03() {
		...
		//取引先、契約の作成
		Party client03 = new Party("切り捨て-安い方", PartyType.法人);
		Contract contract03 = new Contract(ContractType.SALES, client03, new DateRange(date("2013/07/28"),date("2014/07/28")), RD_C, RD,date("2013/07/28"));
		client03.save();
		contract03.save();
		// 注文
	...
	public void UC002ー01ー04() {
		...
		//取引先、契約の作成
		Party client04 = new Party("四捨五入-合計", PartyType.法人);
		Contract contract04 = new Contract(ContractType.SALES, client04, new DateRange(date("2013/07/28"),date("2014/07/28")), RO_S, RD,date("2013/07/28"));
		client04.save();
		contract04.save();
		// 注文
	...
	public void UC002ー01ー05() {
		...
		//取引先、契約の作成
		Party client05 = new Party("四捨五入-明細", PartyType.法人);
		Contract contract05 = new Contract(ContractType.SALES, client05, new DateRange(date("2013/07/28"),date("2014/07/28")), RO_D, RD,date("2013/07/28"));
		client05.save();
		contract05.save();
		// 注文
	...
	public void UC002ー01ー06() {
		...
		//取引先、契約の作成
		Party client06 = new Party("四捨五入-安い方", PartyType.法人);
		Contract contract06 = new Contract(ContractType.SALES, client06, new DateRange(date("2013/07/28"),date("2014/07/28")), RO_C, RD,date("2013/07/28"));
		client06.save();
		contract06.save();
		// 注文
	...
	public void UC002ー01ー07() {
		...
		//取引先、契約の作成
		Party client07 = new Party("切り上げ-合計", PartyType.法人);
		Contract contract07 = new Contract(ContractType.SALES, client07, new DateRange(date("2013/07/28"),date("2014/07/28")), RU_S, RD,date("2013/07/28"));
		client07.save();
		contract07.save();
		// 注文
	...
	public void UC002ー01ー08() {
		...
		//取引先、契約の作成
		Party client08 = new Party("切り上げ-明細", PartyType.法人);
		Contract contract08 = new Contract(ContractType.SALES, client08, new DateRange(date("2013/07/28"),date("2014/07/28")), RU_D, RD,date("2013/07/28"));
		client08.save();
		contract08.save();
		// 注文
	...
	public void UC002ー01ー09() {
		...
		//取引先、契約の作成
		Party client09 = new Party("切り上げ-安い方", PartyType.法人);
		Contract contract09 = new Contract(ContractType.SALES, client09, new DateRange(date("2013/07/28"),date("2014/07/28")), RU_C, RD,date("2013/07/28"));
		client09.save();
		contract09.save();
		// 注文
	...
	public void UC002ー01ー10() {
		...
		//取引先、契約の作成
		Party client10 = new Party("[内税]切り捨て-合計", PartyType.法人);
		Contract contract10 = new Contract(ContractType.SALES, client10, new DateRange(date("2013/07/28"),date("2014/07/28")), RD_S, RD,date("2013/07/28"));
		client10.save();
		contract10.save();
		// 注文
	...
	public void UC002ー01ー11() {
		...
		//取引先、契約の作成
		Party client11 = new Party("[非課税]切り捨て-合計", PartyType.法人);
		Contract contract11 = new Contract(ContractType.SALES, client11, new DateRange(date("2013/07/28"),date("2014/07/28")), RD_S, RD,date("2013/07/28"));
		client11.save();
		contract11.save();
		// 注文
